    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(blank=True, null=True)),
                ('name', custom.fields.NameFieldWithSmallCase(max_length=40, unique=True)),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.PositiveSmallIntegerField(blank=True, help_text='Linux User ID', null=True, unique=True)),
                ('vnc_id', models.PositiveSmallIntegerField(blank=True, help_text='Tiger VNC Port', null=True, unique=True)),
