...
psql -h $db_host -p $db_port -U tmcgis -w $db_name -c "grant usage on schema area to gradecontrol"
psql -h $db_host -p $db_port -U tmcgis -w $db_name -c "grant select on all tables in schema area to gradecontrol"
psql -h $db_host -p $db_port -U tmcgis -w $db_name -c "grant update (geom) on table area.road to gradecontrol"
...
psql -h $db_host -p $db_port -U tmcgis -w $db_name -c "grant usage on schema area to survey"
psql -h $db_host -p $db_port -U tmcgis -w $db_name -c "grant select on all tables in schema area to survey"
psql -h $db_host -p $db_port -U tmcgis -w $db_name -c "grant update (geom) on table area.road to survey"
