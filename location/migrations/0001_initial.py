    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distance_from_road', models.FloatField(blank=True, null=True)),
                ('with_layout', models.BooleanField(default=False)),
                ('date_scheduled', models.DateField(blank=True, help_text='Scheduled date of start of excavation', null=True)),
