    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excavation_start', models.DateField(blank=True, null=True)),
                ('excavation_end', models.DateField(blank=True, null=True)),
                ('with_layout', models.BooleanField(default=False)),
                ('excavated', models.BooleanField(default=False)),
                ('recommended_name', models.CharField(blank=True, max_length=30, null=True)),
