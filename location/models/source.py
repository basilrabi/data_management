        ...
        if self.geom:
            ...
            for polygon in self.geom.coords:
                for shape in polygon:
                    for coords in shape:
                        feature_str += f'{self.id}, {coords[1]}, {coords[0]}, {self.z-3}, {self.name}, {self.ore_class}, {self.mine_block}, {self.ni}, {self.fe}, {self.co}, {self.date_scheduled or ""}, {self.layout_date or ""}\n'
                    feature_str += '0, 0, 0, 0,\n'
            return feature_str
