...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': [models.OrderBy(models.F('laydaysstatement__completed_loading'), descending=True), models.OrderBy(models.F('laydaysstatement__nor_accepted'), descending=True), models.OrderBy(models.F('laydaysstatement__nor_tender'), descending=True), models.OrderBy(models.F('laydaysstatement__arrival_tmc'), descending=True), models.OrderBy(models.F('laydaysstatement__arrival_pilot'), descending=True), models.OrderBy(models.F('name'), descending=True)],
            },
        ),
        migrations.CreateModel(
            name='Buyer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mgb_receipt', models.FileField(blank=True, null=True, upload_to=shipment.functions.filepath_shipment_draftsurvey_receipt)),
            ...
            options={
                'ordering': [models.OrderBy(models.F('shipment__laydaysstatement__completed_loading'), descending=True), models.OrderBy(models.F('shipment__laydaysstatement__nor_accepted'), descending=True), models.OrderBy(models.F('shipment__laydaysstatement__nor_tender'), descending=True), models.OrderBy(models.F('shipment__laydaysstatement__arrival_tmc'), descending=True), models.OrderBy(models.F('shipment__laydaysstatement__arrival_pilot'), descending=True), models.OrderBy(models.F('shipment__name'), descending=True)],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vessel_voyage', custom.fields.AlphaNumeric(blank=True, max_length=8, null=True)),
            ...
            options={
                'ordering': [models.OrderBy(models.F('completed_loading'), descending=True), models.OrderBy(models.F('nor_accepted'), descending=True), models.OrderBy(models.F('nor_tender'), descending=True), models.OrderBy(models.F('arrival_tmc'), descending=True), models.OrderBy(models.F('arrival_pilot'), descending=True)],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['approved', models.OrderBy(models.F('statement__completed_loading'), descending=True), models.OrderBy(models.F('statement__arrival_tmc'), descending=True)],
            },
        ),
        migrations.CreateModel(
            name='LCT',
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['name'], name='shipment_lc_name_fd32e7_idx')],
            },
        ),
        migrations.CreateModel(
            name='LCTContract',
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['interval_from'],
                'constraints': [models.UniqueConstraint(fields=('laydays', 'interval_from'), name='unique_vessel_trip_timestamp'), models.UniqueConstraint(condition=models.Q(('interval_class', 'end')), fields=('laydays', 'interval_class'), name='unique_end_laydaysdetail')],
            },
        ),
        migrations.CreateModel(
            name='TripDetail',
            ...
            options={
                'ordering': ['interval_from'],
                'constraints': [models.UniqueConstraint(fields=('trip', 'interval_from'), name='unique_lct_trip_timestamp'), models.UniqueConstraint(condition=models.Q(('interval_class', 'end')), fields=('trip', 'interval_class'), name='unique_end_tripdetail')],
            },
        ),
        ...
        migrations.AddConstraint(
            model_name='shipment',
            constraint=models.CheckConstraint(condition=models.Q(('demurrage', 0), ('despatch', 0), _connector='OR'), name='dem_des_with_zero'),
        ),
    ]
