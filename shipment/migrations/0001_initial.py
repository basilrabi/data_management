# Generated by Django 3.0 on 2019-12-09 05:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_class', models.CharField(choices=[('continuous loading', 'Continuous Loading'), ('sun drying', 'Sun Drying'), ('heavy swell', 'Heavy Swell'), ('rain', 'Rain'), ('rain and heavy swell', 'Rain and Heavy Swell'), ('waiting for cargo', 'Waiting for Cargo'), ('waiting for cargo due to rejection', 'Waiting for Cargo (rejected)'), ('end', 'End'), ('can test', 'Can Test'), ('others', '-')], max_length=50)),
                ('remarks', models.TextField(blank=True, null=True)),
                ('pause_override', models.BooleanField(default=False, help_text='Exclude this detail as running lay time.')),
