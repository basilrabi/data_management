# Generated by Django 3.0 on 2020-01-15 03:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_class', models.CharField(choices=[('continuous loading', 'Continuous Loading'), ('sun drying', 'Sun Drying'), ('heavy swell', 'Heavy Swell'), ('rain', 'Rain'), ('rain and heavy swell', 'Rain and Heavy Swell'), ('waiting for cargo', 'Waiting for Cargo'), ('waiting for cargo due to rejection', 'Waiting for Cargo (rejected)'), ('end', 'End'), ('vessel arrived behind of schedule', 'Vessel Arrived Behind of Schedule'), ('others', '-')], max_length=50)),
                ('remarks', models.TextField(blank=True, null=True)),
                ('can_test', models.BooleanField(default=False, help_text='Can test was conducted in this interval.')),
                ('laydays', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shipment.LayDaysStatement')),
            ],
            options={
                'ordering': ['interval_from'],
