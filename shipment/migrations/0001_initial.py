# Generated by Django 2.2.7 on 2019-12-02 18:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_class', models.CharField(choices=[('can test', 'Can Test'), ('end', 'End'), ('loading', 'Continuous Loading'), ('others', '-'), ('sun dry', 'Cargo Sun Drying'), ('swell', 'Heavy Swell'), ('rain', 'Rain'), ('rain and swell', 'Rain and Swell'), ('waiting for cargo', 'Waiting for Cargo')], max_length=30)),
                ('remarks', models.TextField(blank=True, null=True)),
